...
class preprocess():
    ...
    def transform(self, data):
        ...
        normalLogger.info('categorical feature encoder...')
        ...
        if self.normalize:
            normalLogger.info('normalize data...')
    ...
    def cat_encoder(self, df, is_train, target=None):
        ...
        normalLogger.info('implement %s encoder' %self.encoder)
